"""Colored error formatting for MGen errors.
...
class ErrorFormatter:
    ...
    def format_error(self, error: MGenError) -> str:
    ...
    def format_simple(self, error: Exception) -> str:
        """Format a regular exception (non-MGen error).
