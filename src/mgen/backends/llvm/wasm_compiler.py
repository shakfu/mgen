...
This module provides functionality to compile MGen LLVM IR to WebAssembly.
...
class WebAssemblyCompiler:
    ...
    def extract_pure_functions(self, llvm_ir: str) -> str:
        """Extract pure user-defined functions from MGen LLVM IR.

        MGen generates LLVM IR with many runtime library declarations (vec_int_*, map_*, etc.).
        ...
        Args:
            llvm_ir: Full LLVM IR from MGen (includes runtime declarations)
    ...
    def compile_mgen_ir(
        ...
        """Compile MGen-generated LLVM IR to WebAssembly.

        Args:
            ir_path: Path to MGen LLVM IR file (.ll)
...
def compile_to_webassembly(
    ...
    """High-level function to compile MGen IR to WebAssembly.
