...
class MGenError : public std::runtime_error {
public:
    explicit MGenError(const std::string& msg) : std::runtime_error(msg) {}
};

class TypeMappingError : public MGenError {
public:
    explicit TypeMappingError(const std::string& msg) : MGenError("Type mapping error: " + msg) {}
};

class UnsupportedFeatureError : public MGenError {
public:
    explicit UnsupportedFeatureError(const std::string& msg) : MGenError("Unsupported feature: " + msg) {}
};
