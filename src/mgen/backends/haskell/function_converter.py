...
def convert_function_with_visitor(converter: "MGenPythonToHaskellConverter", node: ast.FunctionDef) -> str:
    ...
    Args:
        converter: Reference to MGenPythonToHaskellConverter
...
def _convert_main_function(converter: "MGenPythonToHaskellConverter", node: ast.FunctionDef) -> str:
...
def _param_used_as_2d_list(converter: "MGenPythonToHaskellConverter", node: ast.FunctionDef, param_name: str) -> bool:
    """Check if parameter is used as 2D list."""
    return converter._param_used_as_2d_list(node, param_name)


def _returns_2d_list(converter: "MGenPythonToHaskellConverter", node: ast.FunctionDef) -> bool:
