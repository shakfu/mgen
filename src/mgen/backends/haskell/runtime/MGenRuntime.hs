...
{-|
Module      : MGenRuntime
Description : MGen Haskell runtime providing Python-like operations using only Haskell standard library
Copyright   : (c) MGen Project, 2024
License     : MIT
Maintainer  : mgen-dev@example.com
