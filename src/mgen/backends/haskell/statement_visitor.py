...
class HaskellStatementVisitor(ABC):
    ...
    def __init__(self, converter: "MGenPythonToHaskellConverter") -> None:  # type: ignore[name-defined]
        """Initialize visitor with reference to converter for helper methods.

        Args:
            converter: Reference to MGenPythonToHaskellConverter for accessing helper methods
        """
